...
class IriMaps:
  ...
  @classmethod
  def extract_suffix_syns_symbs_maps(cls, rows):
    """
  ...
  @classmethod
  def extract_iri_special_label_maps(cls, rows):
    """
  ...
  @classmethod
  def extract_iri_label_maps(cls, label_rows):
    """
  ...
  @classmethod
  def extract_iri_exact_label_maps(cls, exact_rows, ishort_iris={}):
    """
  ...
  @classmethod
  def extract_iri_short_label_maps(cls, short_rows):
    """
